...
1. **[论文/技术名称]**
   ...
   - **一句话核心贡献**：[精炼总结，≤30字]
   - **摘要精译**：[通俗摘要翻译，3-5句，重点：研究问题、核心方法、主要发现、实验结论。必须覆盖原文核心内容，不得遗漏关键信息]
...
> ⚠️ **强制要求**：Tier 1 条目必须有"摘要精译"，内容来自 raw_context.md 中的"完整摘要"字段，翻译为通俗中文，保留关键数据和方法论细节。
...
- [ ] 所有 Tier 1 学术条目都有"摘要精译"（来自原文"完整摘要"字段）
- [ ] 摘要精译长度 ≥ 3 句，覆盖：研究问题、核心方法、主要发现
